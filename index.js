...
app.get ("/movies/:id", async function(request, response){
    ...
    const movie = await client
        .db("mydb")
        .collection("movies")
        .findOne({id : id}); // left id =>key in object , right id is the destructured element got from the url params
        // console.log(movie)
    movie
...
app.delete ("/movies/:id", async function(request, response){
    ...
    const movie = await client
        .db("mydb")
        .collection("movies")
        .deleteOne({id : id}); // left id =>key in object , right id is the destructured element got from the url params
        // console.log(movie)
